...
public class MhsSearchDemo {
    ...
    listMahasiswa.add(new Mahasiswa("125", "Wawan", "D3IF 43-04"));
    listMahasiswa.add(new Mahasiswa("126", "Farhan", "D3IF 43-04"));
    listMahasiswa.add(new Mahasiswa("127", "Herman", "D3IF 43-04"));
